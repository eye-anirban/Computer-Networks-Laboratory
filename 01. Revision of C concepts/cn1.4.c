...
4. Define a structure emp having data members empid , basic_sal , da , hra and gross_sal .
   Consider da and hra to be each 5% of basic salary .
   Input details of 3 employees and display all details of each one of them. USING POINTERS
...
struct emp *e1=NULL , *e2=NULL , *e3=NULL ;
